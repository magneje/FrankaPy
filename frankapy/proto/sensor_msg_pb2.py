...
_CARTESIANVARIABLEIMPEDANCECONTROLLERSENSORMESSAGE = _descriptor.Descriptor(
  name='CartesianVariableImpedanceControllerSensorMessage',
  full_name='CartesianVariableImpedanceControllerSensorMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='CartesianVariableImpedanceControllerSensorMessage.id', index=0,
      number=1, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='CartesianVariableImpedanceControllerSensorMessage.timestamp', index=1,
      number=2, type=1, cpp_type=5, label=2,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stiffness', full_name='CartesianVariableImpedanceControllerSensorMessage.stiffness', index=2,
      number=3, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='damping', full_name='CartesianVariableImpedanceControllerSensorMessage.damping', index=3,
      number=4, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mass', full_name='CartesianVariableImpedanceControllerSensorMessage.mass', index=4,
      number=5, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['CartesianVariableImpedanceControllerSensorMessage'] = _CARTESIANVARIABLEIMPEDANCECONTROLLERSENSORMESSAGE
...
CartesianVariableImpedanceControllerSensorMessage = _reflection.GeneratedProtocolMessageType('CartesianVariableImpedanceControllerSensorMessage', (_message.Message,), {
  'DESCRIPTOR' : _CARTESIANVARIABLEIMPEDANCECONTROLLERSENSORMESSAGE,
  '__module__' : 'sensor_msg_pb2'
  # @@protoc_insertion_point(class_scope:CartesianVariableImpedanceControllerSensorMessage)
  })
_sym_db.RegisterMessage(CartesianVariableImpedanceControllerSensorMessage)
