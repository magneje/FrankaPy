...
_CARTESIANVARIABLEIMPEDANCEFEEDBACKCONTROLLERMESSAGE = _descriptor.Descriptor(
  name='CartesianVariableImpedanceFeedbackControllerMessage',
  full_name='CartesianVariableImpedanceFeedbackControllerMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stiffness', full_name='CartesianVariableImpedanceFeedbackControllerMessage.stiffness', index=0,
      number=1, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='damping', full_name='CartesianVariableImpedanceFeedbackControllerMessage.damping', index=1,
      number=2, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mass', full_name='CartesianVariableImpedanceFeedbackControllerMessage.mass', index=2,
      number=3, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_commanded_damping', full_name='CartesianVariableImpedanceFeedbackControllerMessage.use_commanded_damping', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_commanded_mass', full_name='CartesianVariableImpedanceFeedbackControllerMessage.use_commanded_mass', index=4,
...
DESCRIPTOR.message_types_by_name['CartesianVariableImpedanceFeedbackControllerMessage'] = _CARTESIANVARIABLEIMPEDANCEFEEDBACKCONTROLLERMESSAGE
...
CartesianVariableImpedanceFeedbackControllerMessage = _reflection.GeneratedProtocolMessageType('CartesianVariableImpedanceFeedbackControllerMessage', (_message.Message,), {
  'DESCRIPTOR' : _CARTESIANVARIABLEIMPEDANCEFEEDBACKCONTROLLERMESSAGE,
  '__module__' : 'feedback_controller_params_msg_pb2'
  # @@protoc_insertion_point(class_scope:CartesianVariableImpedanceFeedbackControllerMessage)
  })
_sym_db.RegisterMessage(CartesianVariableImpedanceFeedbackControllerMessage)
